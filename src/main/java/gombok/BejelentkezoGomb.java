 ...
 * @author kunec
 */
public class BejelentkezoGomb extends JButton implements MouseListener {

    /**
     *
     */
    private static final long serialVersionUID = 9158994354813982531L;
    ...
    private Image szovegKep = new ImageIcon(this.getClass().getResource("/kepek/belepes.png")).getImage();

    public BejelentkezoGomb() {
