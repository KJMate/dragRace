 ...
 * @author kunec
 */
public class MegveszGomb extends JButton implements MouseListener {
    ...
    private Image szovegKep = new ImageIcon(this.getClass().getResource("/kepek/megvesz.png")).getImage();
