 ...
 * @author kunec
 */
public class MentesGomb extends JButton implements MouseListener {
    ...
    private Image szovegKep = new ImageIcon(this.getClass().getResource("/kepek/mentes.png")).getImage();
