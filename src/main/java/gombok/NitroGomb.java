 ...
 * @author kunec
 */
public class NitroGomb extends JButton implements MouseListener {

    private int szelesseg = 50;
    private int magassag = 50;
    private String hangEleres = "/hangok/click.wav";
    private Zene zene;
    private Image gombKep = new ImageIcon(this.getClass().getResource("/kepek/nitroKi.png")).getImage();
