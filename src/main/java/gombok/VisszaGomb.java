 ...
 * @author kunec
 */
public class VisszaGomb extends JButton implements MouseListener {
    ...
    private Image szovegKep = new ImageIcon(this.getClass().getResource("/kepek/vissza.png")).getImage();
